...
Chapter 2: cumulative_contacts.py; tc_contacts.py

Chapter 3: king_references.py

Chapter 4: CutPoint_Ranking.py and Cromwell_model.py

Chapter 5: Gatekeeper_Triads.py (written in collaboration with Dr Sebastian Ahnert, University of Cambridge)

Chapter 8: Cromwell_model.py
